...
const Dropdown = ({ title, dropdownList }) => {
    ...
    return (
        <div>
            <button onClick={handleOpen} className="flex justify-between px-4 py-2 w-full text-white">
                {title}
...
const SearchInputBtn = () => {
    ...
    return (
        <div className="flex justify-center mt-[100px] w-[85%] m-auto">
            {/* Filter Icon on Small Screen */}
            <div className='sm:flex'>
            <button onClick={toggleDropdown} className=" lg:hidden md:hidden gap-4 w-[56px] h-[56px] p-4 text-white rounded-lg mr-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className=' accent-white'>
            ...
            {/*Filter For Medium And Large Screen */}
            <button onClick={toggleDropdown} className="md:flex hidden bg-[#45214A] gap-4 w-[126px] h-[56px] p-4 text-white rounded-lg   mr-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className=' accent-white'>
                    <path d="M5.39844 2.1001H18.5984C19.6984 2.1001 20.5984 3.0001 20.5984 4.1001V6.3001C20.5984 7.1001 20.0984 8.1001 19.5984 8.6001L15.2984 12.4001C14.6984 12.9001 14.2984 13.9001 14.2984 14.7001V19.0001C14.2984 19.6001 13.8984 20.4001 13.3984 20.7001L11.9984 21.6001C10.6984 22.4001 8.89844 21.5001 8.89844 19.9001V14.6001C8.89844 13.9001 8.49844 13.0001 8.09844 12.5001L4.29844 8.5001C3.79844 8.0001 3.39844 7.1001 3.39844 6.5001V4.2001C3.39844 3.0001 4.29844 2.1001 5.39844 2.1001Z" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M10.93 2.09998L6 9.99998" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                </svg>        
            ...
            {isOpen && (
                <div className="bg-[#45214A] flex absolute flex-col justify-between lg:left-[116px] md:left-20 mt-14 rounded-lg w-72 ">
            ...
            <div className="relative w-[100%]">
                <input className="w-full h-[56px] bg-[#f2f2f2] outline-none rounded-lg pr-20 pl-12" type="text" placeholder="Enter your location" />
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#292D32" xmlns="http://www.w3.org/2000/svg" className="absolute  lg:block md:block hidden  left-4 top-1/2 transform -translate-y-1/2">
            ...
            <div >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#292D32" xmlns="http://www.w3.org/2000/svg" className="absolute lg:hidden  md:hidden sm:flex mt-7 ml-4 transform -translate-y-1/2">
                    <path d="M11.5 21C16.7467 21 21 16.7467 21 11.5C21 6.25329 16.7467 2 11.5 2C6.25329 2 2 6.25329 2 11.5C2 16.7467 6.25329 21 11.5 21Z" fill="#292D32" />
                    <path d="M21.2986 21.9996C21.1186 21.9996 20.9386 21.9296 20.8086 21.7996L18.9486 19.9396C18.6786 19.6696 18.6786 19.2296 18.9486 18.9496C19.2186 18.6796 19.6586 18.6796 19.9386 18.9496L21.7986 20.8096C22.0686 21.0796 22.0686 21.5196 21.7986 21.7996C21.6586 21.9296 21.4786 21.9996 21.2986 21.9996Z" fill="#292D32" />
                </svg>
            </div>

            <button className="hidden text-center justify-center bg-[#45214A] w-[126px] h-[56px] p-4 pr-5 text-white rounded-lg lg:flex md:flex ">Search</button>
